...
// ============ CONFIGURACIÓN ============
const char* ssid = "PH4ND4";
const char* password = "PH4ND4!!";
const char* apiUrl = "http://192.168.100.101:3000/api";
const char* testUrl = "http://192.168.100.101:3000/api/test";
const char* insertUrl = "http://192.168.100.101:3000/api/insert";
